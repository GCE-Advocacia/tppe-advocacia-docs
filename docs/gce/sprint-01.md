...
| [US03](./backlog/us03.md) | Controle de faturamento | Guilherme, José, Lucas | Concluído | [`backend #1`](https://github.com/GCE-Advocacia/tppe-advocacia-backend/pull/1) [`frontend #1`](https://github.com/GCE-Advocacia/tppe-advocacia-frontend/pull/1) |
